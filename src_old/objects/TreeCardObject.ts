...
export class TreeCardObject extends CardStack {
  onStart() {
    this.item = new AnimatedSprite(
      [
        this.environment.assets.getTexture(Asset.TREE1),
        this.environment.assets.getTexture(Asset.TREE2),
        this.environment.assets.getTexture(Asset.TREE3),
